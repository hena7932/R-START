...
![](img/img4.png){width="200"}  

실제 조인에서는 매치 항목이 점으로 표시됨  
(점 수 = 매치 수 = 출력 행 수)  
![](img/img5.png){width="400"}

### 4-2. 내부 조인
inner join: 키가 같을 때마다 두 관측값을 매칭함  
![](img/img6.png){width="400"}
